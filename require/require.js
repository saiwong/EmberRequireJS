...
// Added extra requirejs configurations to support jQuery and plugins more easily
require.config({
    priority: ['vender/jquery/jquery.1.7.1.js'],
    ...
    packages: [
        ...
        {
            name: 'hbs',
            location: 'vender/ember',
            main: 'hbs'
        },
        {
            name: 'less',
            location: 'vender/less',
            main: 'less'
        }
    ]
});
